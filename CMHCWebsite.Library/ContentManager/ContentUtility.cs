...
namespace CMHCWebsite.Library.ContentManager
{
    public class ContentUtility
    {
        ...
        private string STAFF_DB_CONN_STRING = "Data Source=chmc-test-staffdb.cfzsqoiopsi0.us-east-1.rds.amazonaws.com;Initial Catalog=StaffDb;Persist Security Info=True;User ID=cmhc_development;Password=AskMe2Care!";
